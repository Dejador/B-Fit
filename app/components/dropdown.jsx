...
export default function Dropdown({ dropdownTitle, dropdownItems }) {
  ...
  useEffect(() => {
    let completeUrlAPI = 'https://exercisedb.p.rapidapi.com/exercises/bodyPart/' + selectedName.replace(/\s/g, '%20')
  ...
  return (
    ...
    <div className='uppercase text-white font-bold text-lg mt-8'>{selectedName}</div>
