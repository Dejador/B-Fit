      ...
      <div className='mt-8 justify-center text-center align-middle flex'>
        <div className='text-white text-center  select-none'>
          <div className='flex w-full'>
            <div className='w-[250px] md:w-[400px] bg-main-light-b border-t border-r border-l py-1 uppercase'>
              {routineTitle}
            </div>
          </div>
          <div className='w-[250px] md:w-[400px] flex justify-end pr-4 bg-secondary-a border py-1'>
            {/* <ActionButton
              ...
              allExercises
                ...
                .map(({ name, id }) => (
                  <div className='flex bg-main-dark-b' key={id}>
                    <div className='w-[250px] md:w-[400px] border-white border-b border-r border-l  py-1 px-2 capitalize'>
                      {name}
                    </div>
                  </div>
                ))
